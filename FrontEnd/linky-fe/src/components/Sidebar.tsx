...
export const Sidebar = () => {
    const links = [
        {
            title: "Home",
            icon: (
                <IconHome className="h-full w-full text-[#c890f9]" />
            ),
            href: "#",
        },

        {
            title: "Products",
            icon: (
                <IconTerminal2 className="h-full w-full text-[#c890f9]" />
            ),
            href: "#",
        },
        {
            title: "Components",
            icon: (
                <IconNewSection className="h-full w-full text-[#c890f9]" />
            ),
            href: "#",
        },
        {
            title: "Changelog",
            icon: (
                <IconExchange className="h-full w-full text-[#c890f9]" />
            ),
            href: "#",
        },

        {
            title: "Twitter",
            icon: (
                <IconBrandX className="h-full w-full text-[#c890f9]" />
            ),
            href: "#",
        },
        {
            title: "GitHub",
            icon: (
                <IconBrandGithub className="h-full w-full text-[#c890f9]" />
            ),
            href: "#",
        },
    ];
    return (
        <>
            <aside className="inset-y-0 lg:block hidden flex-wrap items-center justify-between h-full w-full overflow-y-auto duration-200 bg-[#0F172A] border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-72  z-990" >
                <div className="h-19 w-max">
                    <div className="flex gap-2 justify-center items-center px-5 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700">
                        <Image
                            src={logo}
                            alt="Logo"
                            width={50}
                            height={50}
                        />
                        <h1 className="text-xl font-bold">Linky Dashboard</h1>
                    ...
                    <ul className="flex gap-2 flex-col py-4">

                        {
                            links.map((link, index) => (
                                <li key={index} className="h-12 flex justify-start items-center w-full  font-bold  text-white transition-all ease-in shadow-md hover:bg-[#1E293B]  hover:border-l-2 hover:border-[#c890f9] hover:shadow-xs hover:-translate-y-px">
                                    <Link
                                        href={link.href}
                                        className="py-2.7 gap-2 bg-blue-500/13 dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors" >
                                        <div className="flex h-6 w-6 items-center justify-center rounded-lg ">
                                            {link.icon}
                                        </div>
                                        <span className="ml-1 text-lg duration-300 opacity-100 pointer-events-none ease">{link.title}</span>
                                    </Link>
                                </li>
                            ))
                        }
                ...
                <div className="flex flex-col  justify-end items-center mx-2">
                    <li className="h-10 flex justify-center items-center w-full text-md font-bold  text-white transition-all ease-in rounded-lg shadow-md bg-slate-700 bg-150 hover:shadow-xs hover:-translate-y-px">
                        <Link
                    ...
                    <button className="inline-block w-full px-8 py-2 text-xs font-bold leading-normal text-center text-white align-middle transition-all ease-in bg-blue-500 border-0 rounded-lg shadow-md select-none bg-150 bg-x-25 hover:shadow-xs hover:-translate-y-px" >Upgrade to pro</button>
                </div>

            </aside>
           
            <div
                className="flex lg:hidden justify-around gap-4 items-center px-4 py-1 bg-black rounded-[15px] ring-1 ring-white"
            >
                <div
